<x-layout>
    ...
    <div class="relative max-w-[100rem] mx-auto lg:px-8 sm:px-6 pr-4 sm:py-6">
        ...
        <div class="relative p-5 mb-5 rounded-lg shadow-xl bg-slate-200 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] float-right">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.5rem] sm:left-[-2.25rem] md:left-[-2.45rem] bg-slate-300 border-2 border-slate-500 rounded-full text-center">
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)] md:mt-10">
