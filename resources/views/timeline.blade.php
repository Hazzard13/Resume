<x-layout>
    ...
    <div class="relative max-w-[100rem] mx-auto lg:px-8 sm:px-6 pr-4 sm:py-6">
        <div class="absolute h-[calc(100%-1.25rem)] sm:h-[calc(100%-4.25rem)] ml-3 border-l-2 sm:ml-5 md:right-0 md:w-1/2 border-slate-500">
        ...
        <div class="relative p-5 mb-5 rounded-lg shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] float-right">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.5rem] sm:left-[-2.25rem] md:left-[-2.45rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
            ...
            <h1 class="pb-2 text-xl font-semibold">
                This site!
                <p class="float-right text-sm text-slate-600">
                    Feb. 2022
                </p>
            </h1>
            <p>
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)] md:mt-10">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.5rem] sm:left-[-2.25rem] md:left-auto md:right-[-2.5rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)] md:mt-5">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.5rem] sm:left-[-2.25rem] md:left-auto md:right-[-2.5rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2 md:-left-2"></div>
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-1.5rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:mb-10 md:float-left md:w-[calc(50%-1.5rem)] md:mt-5">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.5rem] sm:left-[-2.25rem] md:left-auto md:right-[-2.5rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2 md:-left-2"></div>
