<x-layout>
    ...
    <div class="relative max-w-[100rem] mx-auto lg:px-8 sm:px-6 pr-4 sm:py-6">
        ...
        <div class="relative p-5 mb-5 rounded-lg shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-2rem)] sm:w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] float-right">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 md:top-5 left-[-1.75rem] sm:left-[-2.25rem] md:left-[-2.45rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2"></div>
                <svg aria-hidden="true" focusable="false" class="w-4 h-4 mx-auto mt-0.5 sm:mt-1 sm:w-5 sm:h-5" role="img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-219 -219 438 438">
                    <g fill="currentColor">
                        <circle r="78"/>
                        <g id="h">
            ...
            <p>
                I started a 1-year contract with the Audio/Video Platform Team at CBC, primarily to help with MediaBoss.
            </p>
        </div>
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-2rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)] 2xl:mt-5">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.75rem] sm:left-[-2.25rem] md:left-auto md:right-[-2.5rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2 md:-left-2"></div>
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-2rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)]">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.75rem] sm:left-[-2.25rem] md:left-auto md:right-[-2.5rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2 md:-left-2"></div>
        ...
        <div class="relative p-5 mb-5 rounded-lg shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-2rem)] sm:w-[calc(100%-2.5rem)] md:w-[calc(50%-1.5rem)] float-right md:mb-20">
            <div class="absolute h-6 w-6 sm:h-8 sm:w-8 bottom-1/2 left-[-1.75rem] sm:left-[-2.25rem] md:left-[-2.45rem] bg-slate-300 dark:bg-slate-900 border-2 border-slate-500 rounded-full text-center">
                <div class="absolute w-4 mt-3 border-b-2 z-[-1] border-slate-500 -right-2"></div>
        ...
        <div class="relative p-5 rounded-lg mb-5 shadow-xl bg-slate-200 dark:bg-slate-800 w-[calc(100%-2rem)] sm:w-[calc(100%-2.5rem)] float-right md:ml-0 md:float-left md:w-[calc(50%-1.5rem)]">
            ...
            <p>
                I went to Redeemer University from 2013-2016, for a Bachelor of Computer Science. Ultimately, however, I decided to pursue my career at Velsoft rather than completing my fourth year. I still learned a great deal, and that period defines much of my coding style today.
            </p>
        </div>
