...
<body class="relative bg-slate-300 pb-10">
    <div class="relative p-5 bg-gradient-to-br from-orange-500 to-amber-400">
        ...
        <div class="text-slate-100 float-right sm:w-3/4">
